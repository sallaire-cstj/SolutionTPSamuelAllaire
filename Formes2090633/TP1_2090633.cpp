...
#include "FonctionsMenus2090633.h"		// Bibliothèque du programmeur rassemblant les fonctions permettant la gestion des menus et la validation des choix fait dans ces menus.
#include "FonctionsFormes2090633.h"		// Bibliothèque du programmeur offrant des fonctions permettant de dessiner différentes formes, pleines ou vides.
using namespace std;
...
int main()
{
   ...
   // Afficher le menu des formes et lire un choix valide. 
	...
	} // Fin du while (choixForme != QUITTER)
